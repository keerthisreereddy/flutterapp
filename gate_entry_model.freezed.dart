...
abstract class _$$GateEntryImplCopyWith<$Res>
  ...
  factory _$$GateEntryImplCopyWith(
    _$GateEntryImpl value,
    $Res Function(_$GateEntryImpl) then,
...
class __$$GateEntryImplCopyWithImpl<$Res>
  ...
  __$$GateEntryImplCopyWithImpl(
    _$GateEntryImpl _value,
    $Res Function(_$GateEntryImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$GateEntryImpl with DiagnosticableTreeMixin implements _GateEntry {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GateEntry'))
      ...
      ..add(DiagnosticsProperty('materialType', materialType))
      ..add(DiagnosticsProperty('supplierName', supplierName))
      ..add(DiagnosticsProperty('entryTime', entryTime))
      ..add(DiagnosticsProperty('customerName', customerName))
      ..add(DiagnosticsProperty('supplierAddress', supplierAddress))
      ..add(DiagnosticsProperty('customerAddress', customerAddress))
      ..add(DiagnosticsProperty('expectedReturnDate', expectedReturnDate))
      ..add(DiagnosticsProperty('senderMobileNo', senderMobileNo))
      ..add(DiagnosticsProperty('receiverName', receiverName))
      ..add(DiagnosticsProperty('receiverDept', receiverDept))
      ..add(DiagnosticsProperty('receiverEmail', receiverEmail))
      ..add(DiagnosticsProperty('receiverMobile', receiverMobile))
      ..add(DiagnosticsProperty('poNumber', poNumber))
      ..add(DiagnosticsProperty('isewayBill', isewayBill))
      ..add(DiagnosticsProperty('ewayBill', ewayBill))
      ..add(DiagnosticsProperty('challanNumber', challanNumber))
      ...
      ..add(DiagnosticsProperty('drivermobileNo', drivermobileNo))
      ..add(DiagnosticsProperty('weightSlipNo', weightSlipNo))
      ..add(DiagnosticsProperty('weight', weight))
      ..add(DiagnosticsProperty('weighmentDate', weighmentDate))
      ..add(DiagnosticsProperty('weighmentTime', weighmentTime))
      ..add(DiagnosticsProperty('remarks', remarks))
      ..add(DiagnosticsProperty('docStatus', docStatus))
      ..add(DiagnosticsProperty('senderName', senderName))
      ..add(DiagnosticsProperty('driversLicensePhoto', driversLicensePhoto))
      ..add(DiagnosticsProperty('vehicleImg', vehicleImg))
      ..add(DiagnosticsProperty('sealPhoto', sealPhoto))
      ..add(DiagnosticsProperty('breathAnalyser', breathAnalyser))
      ..add(DiagnosticsProperty('ocrScanning', ocrScanning))
      ..add(DiagnosticsProperty('totalAmount', totalAmount))
      ..add(DiagnosticsProperty('licensePhotoImg', licensePhotoImg))
      ..add(DiagnosticsProperty('vehiclePhotoImg', vehiclePhotoImg))
      ..add(DiagnosticsProperty('sealPhotoImg', sealPhotoImg))
      ..add(DiagnosticsProperty('breathAnalyserImg', breathAnalyserImg))
      ..add(DiagnosticsProperty('invoiceImg', invoiceImg))
      ..add(DiagnosticsProperty('addInvs', addInvs));
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$GateEntryImplToJson(this);
  }
}
